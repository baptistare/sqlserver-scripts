WITH RedundantQueries AS 
        (SELECT TOP 100 query_hash, statement_start_offset, statement_end_offset,
...
SELECT r.query_hash, r.PlansCached, r.DistinctPlansCached, q.SampleQueryText, q.SampleQueryPlan,
    ...
    CROSS APPLY (SELECT TOP 100 st.text AS SampleQueryText, qp.query_plan AS SampleQueryPlan, qs.total_elapsed_time
